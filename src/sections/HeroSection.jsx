    ...
    >
      <div className="container mx-auto px- relative z-10 max-w-9xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="text-center lg:text-left order-5 lg:order-1">
            ...
            <h1 className="font-display text-[125px] font-bold leading-[1.1] md:leading-[0.9] tracking-tight mb-6 text-slate-900 dark:text-white">
              <div className="hero-heading-line overflow-hidden">
                <span className="block">Code.</span>  
              </div>
              <div className="hero-heading-line overflow-hidden pb-2">
                <span className="relative block left-[-5px] text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-500 to-secondary animate-gradient-x bg-[length:200%_auto] text-[124px] ">
                  Containerize.
                </span>
                <span className="relative block left-[-5px] text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-amber-700 to-orange-800 animate-gradient-x bg-[length:200%_auto] text-[124px]">Deploy.</span>
              </div>
